...
<div>
    ...
    <ul class = "toggle">
       ...
       <li> 강의 정보  <br>
        ...
        &nbsp;&nbsp;4.C++ 문법을 이해하고 활용능력을 배양할 수 있다.</li>
    </ul>
    ...
    <ul class = "toggle">
       ...
       <li> 강의 정보  <br>
        ...
        &nbsp;&nbsp;4.객체지향 원리를 이해하여 효율적인 클래스 설계 능력을 배양할 수 있다.</li>
    </ul>
    ...
    <ul class = "toggle">
       ...
       <li> 강의 정보  <br>
        ...
        &nbsp;&nbsp;3.Develop software using JAVA to solve real world problems<br>
    </ul>
    ...
    <ul class = "toggle">
       ...
       <li> 강의 정보  <br>
        ...
        &nbsp;&nbsp;5.C, C++ 프로그래밍 활용 능력을 강화할 수 있다.<br>
    </ul>
</div>
