...
<div>
    ...
    <h3 class = "trigger">&nbsp;&nbsp;&nbsp;4  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  미적분학 1  &nbsp;&nbsp;&nbsp;&nbsp;  심제동</h3> 
    <ul class = "toggle">
        <li>학점 정보 : 출석 10 과제 20 중간 35 기말 35</li>
        <li>교재 정보 <br>
        &nbsp;&nbsp;- 미분적분학6판( 경문사, 수학교재편찬위원회 옮김)<br></li>
     ...
     <h3 class = "trigger">&nbsp;&nbsp;&nbsp;3  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  대학 기초 수학  &nbsp;&nbsp;&nbsp;&nbsp;  황상민</h3>
    <ul class = "toggle">
     ...
     <h3 class = "trigger">&nbsp;&nbsp;&nbsp;3  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  대학 기초 수학  &nbsp;&nbsp;&nbsp;&nbsp;  홍성희</h3>
    <ul class = "toggle">
        <li>학점 정보 : 출석 10 과제 10 중간 30 기말 30 퀴즈 20</li>
        <li>교재 정보 <br>
        &nbsp;&nbsp;- 기초수학 강의록</li>
     ...
     <h3 class = "trigger">&nbsp;&nbsp;&nbsp;3  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  대학 기초 수학  &nbsp;&nbsp;&nbsp;&nbsp;  한효근</h3>
    <ul class = "toggle">
        <li>학점 정보 : 출석 10 과제 10 중간 30 기말 30 퀴즈 20</li>
        <li>교재 정보 <br>
        &nbsp;&nbsp;- 기초수학 강의록</li>
     ...
     <h3 class = "trigger">&nbsp;&nbsp;&nbsp;3  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  대학 기초 수학  &nbsp;&nbsp;&nbsp;&nbsp;  노귀연</h3>
    <ul class = "toggle">
        <li>학점 정보 : 출석 10 과제 10 중간 30 기말 30 퀴즈 20</li>
        <li>교재 정보 <br>
        &nbsp;&nbsp;- 기초수학 강의록</li>
     ...
     <h3 class = "trigger">&nbsp;&nbsp;&nbsp;3  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  대학 기초 수학  &nbsp;&nbsp;&nbsp;&nbsp;  우현균</h3>
    <ul class = "toggle">
        <li>학점 정보 : 출석 10 과제 10 중간 30 기말 30 퀴즈 20</li>
        <li>교재 정보 <br>
        &nbsp;&nbsp;- 기초수학 강의록</li>
